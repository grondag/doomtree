...
public class DoomItems {
	...
	public static final ArmorMaterial ENCRUSTED_ARMOR_MATERIAL = new SimpleArmorMaterial("encrusted", 37, new int[]{3, 6, 8, 3}, 11, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.5F, () -> {
		return Ingredient.ofItems(WARDED_DIAMOND);
	});
	public static final Item ENCRUSTED_HELMET =  Registry.register(Registry.ITEM, DoomTree.id("encrusted_helmet"), new ArmorItem(ENCRUSTED_ARMOR_MATERIAL, EquipmentSlot.HEAD, (new Item.Settings()).group(DoomTree.GROUP)));
	public static final Item ENCRUSTED_CHESTPLATE =  Registry.register(Registry.ITEM, DoomTree.id("encrusted_chestplate"), new ArmorItem(ENCRUSTED_ARMOR_MATERIAL, EquipmentSlot.CHEST, (new Item.Settings()).group(DoomTree.GROUP)));
	public static final Item ENCRUSTED_LEGGINGS =  Registry.register(Registry.ITEM, DoomTree.id("encrusted_leggings"), new ArmorItem(ENCRUSTED_ARMOR_MATERIAL, EquipmentSlot.LEGS, (new Item.Settings()).group(DoomTree.GROUP)));
	public static final Item ENCRUSTED_BOOTS =  Registry.register(Registry.ITEM, DoomTree.id("encrusted_boots"), new ArmorItem(ENCRUSTED_ARMOR_MATERIAL, EquipmentSlot.FEET, (new Item.Settings()).group(DoomTree.GROUP)));
	...
	public static final Item ENCRUSTED_HOE = Registry.register(Registry.ITEM, DoomTree.id("encrusted_hoe"), new HoeItem(ENCRUSTED_TOOL_MATERIAL, 0.0F, new Item.Settings().group(DoomTree.GROUP)){});
	...
	public static final Item ENCRUSTED_AXE = Registry.register(Registry.ITEM, DoomTree.id("encrusted_axe"), new AxeItem(ENCRUSTED_TOOL_MATERIAL, 5.0F, -3.0F, new Item.Settings().group(DoomTree.GROUP)){});
