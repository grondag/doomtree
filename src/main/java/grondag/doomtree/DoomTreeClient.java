...
import grondag.doomtree.particle.AlchemyParticle;
...
public class DoomTreeClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ParticleFactoryRegistry.getInstance().register(DoomParticles.BASIN_IDLE, AlchemyParticle.IdleFactory::new);
		ParticleFactoryRegistry.getInstance().register(DoomParticles.BASIN_WAKING, AlchemyParticle.WakingFactory::new);
	}
}
